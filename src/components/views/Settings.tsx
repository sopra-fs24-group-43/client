...
const Settings = ({ isOpen, onClose, hotkeyInputDraw, setHotkeyInputDraw, hotkeyInputFill, setHotkeyInputFill, hotkeyInputEraser, setHotkeyInputEraser, hotkeyInputClear, setHotkeyInputClear}) => {
